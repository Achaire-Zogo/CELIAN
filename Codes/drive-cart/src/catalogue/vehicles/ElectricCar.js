...
function ElectricCar({ isCart = false, props }) {
  const { id, marque, model, price, uri, options, batteryCapacity, drivingRange } = props;
    ...
    >
      ...
      <CardContent sx={{ flexGrow: 1 }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
          ...
          <br />
          <strong>Driving Range:</strong> {drivingRange} km
        </Typography>
