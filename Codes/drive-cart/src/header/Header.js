...
function Header() {
    ...
    const setCatalog = (e)=>{
      ...
      console.log(val);
       ...
       results = results.filter((item)=> item === val);
       if(results.length === 0) results = [];
       console.log(results.length);
        
       // dispatch(authActions.setCatalog(results));
      ...
      <Box sx={{ flexGrow: 1 }}>
        <AppBar position="fixed">
          <Toolbar>
            ...
            <IconButton LinkComponent={Link} to={'/cart'} size="large" aria-label="show 4 new mails" color="inherit">
